...
/** Low-level access to DIDAQ registers
 *
...
#define DIDAQ_REGS(REG)\
  ...
  REG(DATA          , 0x0014,    24,    0,   1,    uint8_t )\
...
#define DIDAQ_VARREAD_PARAM_1  size_t num_rbytes,
#define DIDAQ_VARREAD_PARAM_0
#define DIDAQ_VARREAD_PARAM(X)  DIDAQ_VARREAD_PARAM_##X

#define DIDAQ_NUM_ADDR_PARAM_N size_t offset,
#define DIDAQ_NUM_ADDR_PARAM_1
#define DIDAQ_NUM_ADDR_PARAM_5 DIDAQ_NUM_ADDR_PARAM_N
#define DIDAQ_NUM_ADDR_PARAM_10 DIDAQ_NUM_ADDR_PARAM_N
#define DIDAQ_NUM_ADDR_PARAM_12 DIDAQ_NUM_ADDR_PARAM_N
#define DIDAQ_NUM_ADDR_PARAM_24 DIDAQ_NUM_ADDR_PARAM_N
#define DIDAQ_NUM_ADDR_PARAM(X)  DIDAQ_NUM_ADDR_PARAM_##X
...
#define DIDAQ_IF_RW_1(NAME, NADDR, T) \
...
#define DIDAQ_IF_RW_0(NAME, NADDR, T)

#define DIDAQ_IF_RW(RW, NAME, NADDR, T) DIDAQ_IF_RW_INNER(RW, NAME, NADDR, T)
#define DIDAQ_IF_RW_INNER(RW, NAME, NADDR,  T) DIDAQ_IF_RW_##RW(NAME, NADDR, T)
#define DIDAQ_WRITE_FNS(NAME, ADDR, NADDR, RW, VAR,  T) DIDAQ_IF_RW(RW, NAME, NADDR, T)
